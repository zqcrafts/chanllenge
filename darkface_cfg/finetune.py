# contain GN \ resize640,640 \ Diouloss \ backbone \ inception \ iou-aware \ DCN
norm_cfg=dict(type='GN', num_groups=32, requires_grad=True)
#norm_cfg=dict(type='BN', requires_grad=True)
model = dict(
    type='RetinaNet', 
    # pretrained='torchvision://resnet50',
    # pretrained = '/gdata2/zhuqi/work_dirs/tinaface/widerface/epoch_120.pth',
    pretrained = None,
    backbone=dict(
        type='ResNet', 
        depth=50,
    ...
    bbox_head=dict(
        type='IoUAwareRetinaHead',  # 两个分支，每支4个卷积层
...
data = dict(
    ...
    test=dict(
        ...
        '/gdata1/zhuqi/DarkFace_coco_0.666/annotations/val_annotations.json',
        img_prefix=
        '/gdata1/zhuqi/DarkFace_coco_0.666/equalization_val',
        pipeline=test_pipeline))
...
log_level = 'INFO'
load_from = '/gdata2/zhuqi/work_dirs/tinaface/widerface/epoch_120.pth'
resume_from = '/gdata2/zhuqi/work_dirs/tinaface/widerface/epoch_120.pth'
workflow = [('train', 1)]
work_dir = '/gdata2/zhuqi/work_dirs/tinaface/finetune'
gpu_ids = range(0, 1)
