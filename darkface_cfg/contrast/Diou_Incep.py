...
data = dict(
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/gdata1/zhuqi/DarkFace_coco_0.666/annotations/test_dev.json',
        img_prefix=
        '/gdata1/zhuqi/DarkFace_coco_0.666/test/',
        pipeline=test_pipeline))
...
resume_from = '/gdata2/zhuqi/work_dirs/tinaface/contrast/Diou_Incep/epoch_150.pth'
workflow = [('train', 1)]
work_dir = '/gdata2/zhuqi/work_dirs/tinaface/contrast/Diou_Incep'
gpu_ids = range(0, 1)
