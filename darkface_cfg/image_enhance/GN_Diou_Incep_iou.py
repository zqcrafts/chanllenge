...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=
        '/gdata1/zhuqi/DarkFace_coco_0.666/self_supervised_train/',
    ...
    val=dict(
        ...
        img_prefix=
        '/gdata1/zhuqi/DarkFace_coco_0.666/self_supervised_val/',
...
workflow = [('train', 1)]
work_dir = '/gdata2/zhuqi/work_dirs/tinaface/image_enhance/self_supervise'
gpu_ids = range(0, 1)
